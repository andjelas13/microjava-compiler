...
public class AssignSetopLabel extends AssignTail {

    private Designator Designator;
    private Setop Setop;
    private Designator Designator1;

    public AssignSetopLabel (Designator Designator, Setop Setop, Designator Designator1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AssignSetopLabel(\n");
